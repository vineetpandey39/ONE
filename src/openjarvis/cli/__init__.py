...
def cli(ctx: click.Context, verbose: bool, quiet: bool) -> None:
    ...
    # Load any credentials saved via the Tools/Data Sources credential picker
    # (core/credentials.py's save_credential()) into os.environ for this
    # process. Without this, a key saved to credentials.toml only ever takes
    # effect for the remainder of the process that saved it — a fresh
    # `jarvis serve` (or any other subcommand) would never pick it up.
    inject_credentials()
