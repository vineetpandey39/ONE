"""Dashboard visibility bridge for the Punarnirman pipeline.

Punarnirman is a deterministic, code-driven agent registered in
...
Rather than rebuild Punarnirman as an LLM tool-calling "managed agent"
...
_DASHBOARD_AGENT_NAME = "Punarnirman"
_manager_cache = None
...
def _get_or_create_record(manager) -> Optional[str]:
    try:
        ...
        logger.warning("Punarnirman dashboard bridge: could not get/create record: %s", exc)
        return None


class DashboardRun:
    """Context-manager-free helper tracking one Punarnirman run's dashboard state."""
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            logger.warning("Punarnirman dashboard bridge: init failed: %s", exc)
    ...
    def log(self, event_type: str, description: str, data: Optional[Dict[str, Any]] = None) -> None:
        ...
        try:
            ...
            logger.warning("Punarnirman dashboard bridge: log failed: %s", exc)
    ...
    def finish(
        ...
        *,
        ...
        try:
            ...
            logger.warning("Punarnirman dashboard bridge: finish failed: %s", exc)
